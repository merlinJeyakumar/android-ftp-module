...
class AnalyticsManager(
    ...
    companion object {
        ...
        @JvmStatic
        fun getInstance(context: Context, appSettingsRepository: AppSettingsRepository): AnalyticsManager {
            if (INSTANCE == null) {
                synchronized(AnalyticsManager::javaClass) {
                    INSTANCE = AnalyticsManager(context, appSettingsRepository)
                }
            }
            return INSTANCE!!
        }
