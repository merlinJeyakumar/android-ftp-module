package com.support.widgets.spinnerdatepicker;
...
public class DatePicker extends FrameLayout {
    ...
    private void SpinnerEditText() {
        mMonthSpinnerInput.setOnEditorActionListener((v, actionId, event) -> {
        ...
        mDaySpinnerInput.setOnEditorActionListener((v, actionId, event) -> {
            if (actionId == EditorInfo.IME_ACTION_NEXT) {
