...
public class WatermarkImage {
    ...
    private WatermarkGravity watermarkGravity = new WatermarkGravity(0, WatermarkGravity.NONE);
    ...
    public WatermarkImage(Context context, @DrawableRes int imageDrawable,WatermarkGravity watermarkGravity) {
        this.imageDrawable = imageDrawable;
        this.context = context;
    ...
    public WatermarkGravity getWatermarkGravity() {
        return watermarkGravity;
    }

    public void setWatermarkGravity(WatermarkGravity watermarkGravity) {
        this.watermarkGravity = watermarkGravity;
    }
}
